...
Billions provides a hosted payment flow for accepting payments without building your own checkout or payment-status infrastructure.

Your backend creates an invoice, redirects the customer to the hosted payment page, and confirms the result by retrieving the invoice from the authenticated Billions API.
